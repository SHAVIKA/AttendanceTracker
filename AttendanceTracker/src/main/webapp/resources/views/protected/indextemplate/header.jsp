...
<header class="main-header">
	<a href="" class="logo"> <span class="logo-mini"><b>A</b>TS</span> <span class="logo-lg"><b>Attendance</b> Tracker</span>
	</a>
	<!-- Header Navbar -->
				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header"><img src="resources/assets/image/user2-160x160.png" class="img-circle" alt="User Image" />
							<p>
								<span class="hidden-md">${user.email}</span><small>[ Web Developer ]</small>
							</p>
							<p>
								<small class="hidden-sm">Last visited 31,Dec,2015 11:52:30 IST</small>
							</p></li>
						<!-- Menu Body -->
						<li class="user-body  clearfix">
							<div class="col-md-6 pull-left">
								<a href="" class="btn btn-sm btn-block btn-flat">Password Change</a>
							</div>
							<div class="col-md-6 pull-right">
								<a href="" class="btn btn-sm btn-block btn-flat">FeedBack</a>
							</div>
						</li>
						<!-- Menu Footer-->
